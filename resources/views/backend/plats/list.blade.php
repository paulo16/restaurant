...
@section('head')
    <title>Valencienne | Liste des plats</title>
@endsection
...
@section('content')
    <div class="tr-single-box">
        ...
        <div class="tr-single-header">
            <h4><i class="ti-share"></i>Plats</h4>
        </div>
        ...
        <div class="tr-single-body">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="m-b-30">
                        <a role="button" href="{{ route('plat.create') }}" id="add-plat"
